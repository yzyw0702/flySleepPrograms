...
dirRoot = 'D:/video/20180514_arousal-cross-lines/20180514_arousal-cross-lines/arousal'
fInput = os.path.join(dirRoot, 'arousal_detal_v3.txt')
lDiffStk, lRtStk, llMeanCurve, llSemCurve = parseInput(fInput)
fOutDiff = os.path.join(dirRoot, 'arousal_intensity_v3.txt')
printArousalIntensity(lDiffStk, fOutDiff)
fOutRt = os.path.join(dirRoot, 'normal_activity_v3.txt')
